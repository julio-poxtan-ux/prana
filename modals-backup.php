<!-- Nivel 4 -->
<div class="modal fade modal-lg" id="nivel-4" tabindex="-1" aria-labelledby="nivel-4" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body image-container">
                    ...
                    <!-- <img src="sourse/niveles/mobile-n4.jpg" alt="nivel 4" class="img-fluid img-mobile"> -->
                    <div class="overlay">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-container">
                                    <a type="button" onclick="mostrarContenido(16)" class="btn-lotus-l ml_5">
                                        <img src="sourse/buttons/nivel-4-lotus-404.svg" class="img-fluid" alt="Lotus">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="btn-container">
                                    <a type="button" onclick="mostrarContenido(15)" class="color-apartado ml_5">
                                        <img src="sourse/buttons/nivel-4-lotus-402.svg" class="img-fluid" alt="Lotus">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="btn-container">
                                    <a type="button"  class="ml_5">
                                        <img src="sourse/buttons/nivel-4-aura-403.svg" class="img-fluid" alt="Aura">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="btn-container">
                                    <a type="button" onclick="mostrarContenido(13)" class="btn-lotus-l ml_5">
                                        <img src="sourse/buttons/nivel-4-aura-401.svg" class="img-fluid" alt="Aura">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="content-16" class="content">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <a href="#precios30" class="btn btn-lg btn-prana mt-4 dropdown-i" data-bs-toggle="collapse">30% de enganche <img src="sourse/down-icon.svg" alt=""><br> 70% contraentrega </a>
                                ...
                                <a href="#precios50" class="btn btn-lg btn-prana mt-4 dropdown-i" data-bs-toggle="collapse">50% de enganche <img src="sourse/down-icon.svg" alt=""><br> 50% contraentrega</a>
                                ...
                                <a href="#precios90" class="btn btn-lg btn-prana mt-4 dropdown-i" data-bs-toggle="collapse">90% de enganche <img src="sourse/down-icon.svg" alt=""><br>10% contraentrega</a>
                        ...
                        <br>
                        <button type="button" class="btn btn-secondary" onclick="regresar()"><svg width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal-body image-container">
                    ...
                    <div class="overlay">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-container">
                                    <a type="button" onclick="mostrarContenido(6)" class="btn-aura-r ml_5">
                                        <img src="sourse/buttons/nivel-2-aura-203.svg" alt="Aura"
                                        ></a>
                                </div>
                            </div>
                            <div class="col-md-6">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-5">
          <p>En LUVORA, nos tomamos muy en serio la privacidad de nuestros usuarios y la protección de sus datos personales. Esta Política de Privacidad tiene como objetivo proporcionar información clara y transparente sobre cómo recopilamos, utilizamos, divulgamos, transferimos y almacenamos los datos personales de los usuarios que visitan nuestro sitio web.</p>

          <h2>1. INFORMACIÓN RECOPILADA</h2>
          <p>Cuando los usuarios visitan nuestro sitio web, podemos recopilar cierta información personal que nos proporcionan de forma voluntaria, como nombre, dirección de correo electrónico, número de teléfono y cualquier otra información que decidan compartir con nosotros a través de formularios de contacto o suscripción a boletines informativos.</p>
          <p>Además de la información personal proporcionada de forma voluntaria, también recopilamos automáticamente ciertos datos técnicos y de navegación, como la dirección IP del dispositivo, tipo de navegador, proveedor de servicios de Internet, páginas de referencia/salida y registros de fecha/hora. Esta información se recopila de forma anónima y se utiliza para fines estadísticos y de análisis, con el objetivo de mejorar constantemente la experiencia del usuario en nuestro sitio web.</p>
          ...
          <p>Implementamos medidas de seguridad técnicas, administrativas y físicas para proteger la información personal contra acceso no autorizado, pérdida, alteración o destrucción. Sin embargo, no podemos garantizar la seguridad absoluta de la información transmitida a través de Internet o almacenada electrónicamente. Los usuarios son responsables de mantener la confidencialidad de sus credenciales de acceso y comunicarse con nosotros de inmediato si sospechan algún uso no autorizado de su cuenta.</p>

          <h2>5. ENLACES A SITIOS WEB DE TERCEROS</h2>
          <p>Nuestro sitio web puede contener enlaces a sitios web de terceros. Esta Política de Privacidad no se aplica a esos sitios web, por lo que le recomendamos revisar las políticas de privacidad correspondientes a esos sitios antes de proporcionarles su información personal.</p>

          <h2>6. MENORES DE EDAD</h2>
          <p>No recopilamos de manera intencional información personal de menores de 18 años. Si usted es padre o tutor y cree que su hijo ha enviado información personal favor de comunicarse para tener una pronta respuesta, al igual que no nos hacemos responsables de cualquier información que el menor de edad haya recopilado en nuestra página web.</p>

          <h2>7. MEDIOS PARA LIMITAR EL USO O DIVULGACIÓN DE DATOS PERSONALES</h2>
          <p>LUVORA cuenta con medidas físicas, técnicas y administrativas de seguridad para la protección de Datos Personales proporcionados por los clientes. Si usted desea dejar de recibir mensajes promocionales vía correo electrónico y/o de forma impresa y/o vía telefónica por parte de nosotros puede solicitarlo a través del correo: contacto@luvora.com.mx.</p>

          <h2>8. TRANSFERENCIA DE DATOS PERSONALES</h2>
          <p>LUVORA podrá revelar, divulgar y/o transferir dentro y fuera del país los Datos Personales (con excepción de los Datos financieros) proporcionados por los clientes a un tercero, incluyendo sin limitar, a sus empresas filiales, subsidiarias y/o relacionadas, así como a proveedores, patrocinadores, publicistas, contratistas y/o socios comerciales para fines comerciales, como proporcionar datos estadísticos a anunciantes potenciales, enviar publicidad a los clientes de acuerdo a sus intereses específicos, conducir investigaciones de mercado, y otras actividades o promociones que LUVORA considere apropiadas. Los terceros que reciban la información relacionada con los Datos Personales de los clientes están obligados a cumplir con lo previsto en este Aviso de Privacidad, así como con los Términos y Condiciones del Sitio y de la legislación aplicable en México. El titular de los Datos Personales proporcionados a través del Sitio acepta su transferencia en los términos descritos en el presente Aviso.</p>

          <h2>9. TRANSFERENCIA INTERNACIONAL DE DATOS</h2>
          <p>Es posible que transfiramos y almacenemos la información personal recopilada en servidores ubicados en diferentes jurisdicciones, incluidas aquellas fuera de su país de residencia. Tomaremos todas las medidas razonables para garantizar que se apliquen los niveles adecuados de protección de datos a cualquier transferencia de información personal.</p>
          ...
          <ul>
            ...
            <li>Oponerse por causa legítima al Tratamiento de sus Datos Personales, y/o Revocar su consentimiento para el tratamiento de sus Datos Personales en cualquier momento, a fin de que se deje de hacer uso de los mismos.</li>
          </ul>
          <p>El ejercicio de los derechos de Acceso, Rectificación, Cancelación u Oposición de Datos Personales y Revocación del consentimiento que realicen los clientes deberá realizarse previa solicitud a LUVORA y contener al menos lo siguiente:</p>
          <ul>
          ...
          <p>Para efecto de lo anterior LUVORA pone a disposición de los clientes el siguiente correo electrónico: contacto@luvora.com.mx, LUVORA dará respuesta a la solicitud de los clientes en un plazo no mayor a 15 días hábiles contados a partir de la fecha en que reciba la petición correspondiente, a través del correo electrónico que haya sido proporcionado para tal efecto.</p>
          ...
          <p>De conformidad con la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, como "Datos Personales Sensibles" se entiende a: "aquellos que puedan revelar aspectos como origen racial o étnico, estado de salud presente y futuro, información genética, creencias religiosas, filosóficas y/o morales, afiliación sindical, opiniones políticas, preferencia sexual". En caso de que LUVORA llegue a requerir Datos Personales Sensibles de los clientes, estos deberán proporcionar su consentimiento expreso.</p>

          <h2>12. CAMBIOS AL AVISO DE PRIVACIDAD</h2>
          <p>LUVORA se reserva el derecho de modificar en cualquier momento el contenido del presente Aviso de Privacidad. Cualquier cambio en el Aviso de Privacidad le será informado a sus clientes enviando un aviso personal. Una vez que se conozca el Aviso de Privacidad y esté firmado por el cliente entrará en vigor automáticamente.</p>
      </div>
    </div>
  </div>
</div>
